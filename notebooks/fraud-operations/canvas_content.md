# FINS Data Engineering Notebook Template
# FINS Data Engineering Notebook Template
...
BUSINESS_UNIT = "Fraud Operations"  # Options: New Accounts, etc...

#Customer Context#
CUSTOMER_NAME = "Example Bank"
DEMO_SCENARIO = "Example Scenario"
CONTEXT_FILE = "notebooks/customers/example-bank/context.md"
...
BU_CONFIG = {
    "Fraud Operations": {
        "constituents": ["Cardholders", "Authorized Users", "Card Transactions"],
        "primary_metrics": ["Transaction Amount", "Transaction Frequency", "Transaction Delta Seconds"],
        "pipeline_stages": ["Transaction", "Application Started", "Application Submitted", "Accepted", "Enrolled"]
    }
}
...
#Example: Generate data with drama (recent decline)#
...
TABLE_NAMES = ["cardholders", "card_transactions", "authorized_users"]
...
for table_name in TABLE_NAMES:
    ...
    # Load corresponding dataframe (assumes df_cardholders, df_card_transactions, df_authorized_users exist)
